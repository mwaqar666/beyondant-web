...
Route::group(['middleware' => 'non-testing-env'], static function() {

    Route::get('/enter-testing-env', ['as' => 'validate-testing-env', 'uses' => 'TestingEnvController@askForAuthentication']);
    Route::post('/authenticate-testing-credentials', ['as' => 'authenticate-testing-credentials', 'uses' => 'TestingEnvController@authenticate']);
});
