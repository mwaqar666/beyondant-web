            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-3 wow fadeInRight">
                        ...
                        @endguest
                        {{--<a class="btn btn-default saveContact link" href="{{route('vcards',['action' => 'export', 'id' => $record->id])}}"> SAVE TO CONTACTS--}}
                        ...
                        <div class="pCd_right">
                            ...
                            <div class="pCd_col">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="row">
                                            @if (empty($record->website_address))
                                                <div class="col-lg-2 col-md-2 col-1 col-R-paddN">
                            ...
                            <div class="pCd_col noBordercol">
                                ...
                                @if (!!$record->appointment_booking)
                                    <a href="{!! $record->appointment_booking !!}" title="Appointment Booking" target="_blank">
                                        <img src="{{asset('assets/front/images/')}}/calendar_phone-removebg-preview.png" title="Appointment Booking" style="width: 100%;max-width: 31px;height: auto;object-fit: contain;">
                                    </a>
                                @endif
                                @if (!!$record->cash_app)
                                    <a href="{{ 'https://cash.app/' . $record->cash_app }}" title="Cash App" target="_blank">
                                        <img src="{{asset('assets/front/images/')}}/aas.png" title="Cash App" style="width: 100%;max-width: 32px;height: auto;object-fit: contain;">
                                    </a>
                                @endif
                            </div>
                        </div>
    ...
    <div class="profileWrapper_Mob">
        ...
        <footer class="profileFooter_mob">
            <div class="text-center m-b-20">
                ...
                <a href="{{ $record->tiktok ?? '' }}" title="Tiktok" class="link"> <img src="{{asset('assets/front/images/')}}/tiktok-icon-3d.png" title="Tiktok"></a>
                @if (!!$record->appointment_booking)
                    <a href="{!! $record->appointment_booking !!}" title="Appointment Booking">
                        <img src="{{asset('assets/front/images/')}}/calendar_phone-removebg-preview.png" title="Appointment Booking" style="width: 100%;max-width: 31px;height: auto;object-fit: contain;">
                    </a>
                @endif
                @if (!!$record->cash_app)
