                                ...
                                <form action="{{ route('update-profile',$record->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-lr">
                                            <div class="form-group">
                                                <input type="text" class="input-text @error('cash_app') is-invalid @enderror" id="cash_app" value="{{ $record->cash_app ?? '' }}" name="cash_app" placeholder="Cash App" autocomplete="cash_app">
                                            </div>
                                        </div>
                                        
                                        <div class="col-lg-12 col-lr">
                                            <div class="form-group">
                                                <input type="text" class="input-text @error('appointment_booking') is-invalid @enderror" id="appointment_booking" value="{{ $record->appointment_booking ?? '' }}" name="appointment_booking" placeholder="Appointment Booking" autocomplete="appointment_booking">
                                            </div>
                                        </div>
