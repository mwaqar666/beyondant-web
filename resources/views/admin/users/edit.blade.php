...
{{--                            @endif--}}
                            <form class="form-horizontal form-label-left" method="POST" action="{{ route('post.update',$record->id) }}" enctype="multipart/form-data" novalidate>
                                ...
                                @if (auth()->user()->role_id!==1)
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align">{{__('What should you want to view on your website')}} <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 form-check-inline">
                                            <input type="radio" class="form-check-input" name="website_address" id="profile-view-website" value="Website" @if ($record->website_address === 'Website') checked @endif required/>
                                            <label for="profile-view-website" class="form-check-label pr-2">Website</label>
                                            <input type="radio" class="form-check-input" name="website_address" id="profile-view-address" value="Address" @if ($record->website_address === 'Address') checked @endif required/>
                                            <label for="profile-view-address" class="form-check-label pr-2">Address</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <label for="appointment_booking" class="col-form-label col-md-3 label-align">{{ __('Appointment Booking') }}</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input id="appointment_booking" type="text" name="appointment_booking" value="{{ $record->appointment_booking }}"  class="form-control" autocomplete="appointment_booking">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <label for="cash_app" class="col-form-label col-md-3 label-align">{{ __('Cash App Username') }}</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input id="cash_app" type="text" name="cash_app" value="{{ $record->cash_app }}"  class="form-control" autocomplete="cash_app">
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input id="occupation" type="text" name="occupation" value="{{ $record->occupation ?? "" }}" data-validate-length-range="5,100" class="optional form-control">
                                    </div>
                                </div>
