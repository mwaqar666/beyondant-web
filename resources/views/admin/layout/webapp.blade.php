                                ...
                                <li><a><i class="fa fa-user"></i> Users <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        @if(in_array('viewUserProfile',\Request::get('permission')))
                                            <li>
                                                <a href="{{ route('profile') }}">Basic Profiles</a>
                                            </li>
                                        @endif

                                        @if(in_array('viewCompany',\Request::get('permission')))
                                            <li>
                                                <a href="{{ route('company') }}">Company Profiles</a>
                                            </li>
                                        @endif

                                        @if(in_array('viewIndividual',\Request::get('permission')))
                                            <li>
                                                <a href="{{ route('individual') }}">Multi-Device Profiles</a>
                                            </li>
                                        @endif
                                    </ul>
                                </li>
                    ...
                    <ul class=" navbar-right">
                        ...
                        <li class="nav-item dropdown open" style="padding-left: 15px;">
                            ...
                            <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{url('admin/user/edit/'.Auth::user()->id)}}">{{auth()->user()->role_id===5?"Company Profile":"My Profile"}}</a>
